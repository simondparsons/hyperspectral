...
Many of the above scripts use command-line arguments because that
suits my style of working. This uses the old-fashioned method via the
sys package and sys.argv. Would have been better to use argparse, but
that is all water under the bridge and using the same approach
throughlut for consistency. If you are runing any of this code in
Jupyter, you will want to concentrate on utils.py.
...
sample.py, picker.py and plotter.py
